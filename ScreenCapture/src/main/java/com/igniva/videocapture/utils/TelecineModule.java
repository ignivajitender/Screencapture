...
import com.igniva.videocapture.BuildConfig;
...
public final class TelecineModule {
  private static final String PREFERENCES_NAME = "SCREENCAPTURE";
  ...
  public TelecineModule(BaseApplication app) {
    this.app = app;
  }
  ...
  BooleanPreference provideShowCountdownPreference(
